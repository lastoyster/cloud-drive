...
import DocumentTrashPage from "../document/[documentId]/starred/trash/page";
...
const DocumentsrashPage = async({params}: DocIdProps )=>{
    const { userId } = auth();
    const folders = await getFiles(params.documentId,userId);
